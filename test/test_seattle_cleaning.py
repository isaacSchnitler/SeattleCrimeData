...
path.insert(1, '/Users/IsaacSchnitler/Desktop/p_projects/SeattleCrimeData/src')
...
class CleaningUnitTesting(unittest.TestCase):
    ...
    def test_cleanup_whitespace(self):
        ...
        input_df = sc.cleanup_whitespace(seattle_data=input_df)
    ...
    def test_cleanup_column_casing(self):
        ...
        input_df = sc.cleanup_column_casing(seattle_data=input_df)
    ...
    def test_cleanup_na_values(self):
        ...
        input_df = sc.cleanup_na_values(seattle_data=input_df)
    ...
    def test_clear_non_crimes(self):
        ...
        input_df = sc.clear_non_crimes(seattle_data=input_df)
    ...
    def test_cleanup_addresses(self):
        ...
        input_df = sc.cleanup_addresses(seattle_data=input_df)
    ...
    def test_cleanup_dtypes(self):
        ...
        input_df = sc.cleanup_dtypes(seattle_data=input_df)
    ...
    def test_correct_offense_datetime(self):
        ...
        input_df = sc.correct_offense_datetime(seattle_data=input_df)
    ...
    def test_cleanup_report_number(self):
        ...
        input_df        = sc.cleanup_dtypes(seattle_data=input_df)
        expected_output = sc.cleanup_dtypes(seattle_data=input_df)

        input_df        = sc.cleanup_report_number(seattle_data=input_df)
    ...
    def test_cleanup_misspelled_mcpp(self):
        ...
        input_df = sc.cleanup_misspelled_mcpp(seattle_data=input_df)
    ...
    def test_correct_na_loc_codes(self):
        ...
        input_df = sc.correct_na_loc_codes(input_df)
    ...
    def test_correct_deci_degrees(self):
        ...
        input_df = sc.correct_deci_degrees(seattle_data=input_df)
    ...
    def test_config_na_values(self):
        ...
        input_df = sc.config_na_values(seattle_data=input_df)
